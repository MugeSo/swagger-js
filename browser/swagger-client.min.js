...
},{"./helpers":4,"js-yaml":19,"lodash-compat/lang/isObject":144,"lodash-compat/object/keys":149,"superagent":160}],6:[function(require,module,exports){
"use strict";function isAbsoluteUrl(e){return 0===e.indexOf("http://")||0===e.indexOf("https://")}var SwaggerHttp=require("./http"),_={isObject:require("lodash-compat/lang/isObject"),cloneDeep:require("lodash-compat/lang/cloneDeep"),isArray:require("lodash-compat/lang/isArray"),isString:require("lodash-compat/lang/isString")},Resolver=module.exports=function(){this.failedUrls=[],this.resolverCache={},this.pendingUrls={}};Resolver.prototype.processAllOf=function(e,i,r,t,o,s){var n,l,f;r["x-resolved-from"]=["#/definitions/"+i];var a=r.allOf;for(a.sort(function(e,i){return e.$ref&&i.$ref?0:e.$ref?-1:1}),n=0;n<a.length;n++)f=a[n],l="/definitions/"+i+"/allOf",this.resolveInline(e,s,f,t,o,l)},Resolver.prototype.resolve=function(e,i,r,t){this.spec=e;var o,s,n=i,l=r,f=t,a={};"function"==typeof i&&(n=null,l=i,f=r);var p=n;this.scope=f||this,this.iteration=this.iteration||0,this.scope.options&&this.scope.options.requestInterceptor&&(a.requestInterceptor=this.scope.options.requestInterceptor),this.scope.options&&this.scope.options.responseInterceptor&&(a.responseInterceptor=this.scope.options.responseInterceptor);var h,c,d,v,u=0,m={},O={},y=[];e.definitions=e.definitions||{};for(h in e.definitions){var g=e.definitions[h];if(g.$ref)this.resolveInline(n,e,g,y,O,g);else{for(v in g.properties)d=g.properties[v],_.isArray(d.allOf)?this.processAllOf(n,h,d,y,O,e):this.resolveTo(n,d,y,"/definitions");g.allOf&&this.processAllOf(n,h,g,y,O,e)}}e.parameters=e.parameters||{};for(h in e.parameters){var x=e.parameters[h];if("body"===x.in&&x.schema)if(_.isArray(x.schema.allOf)){for(var b="inline_model",h=b,A=!1,j=0;!A;){if("undefined"==typeof e.definitions[h]){A=!0;break}h=b+"_"+j,j++}e.definitions[h]={allOf:x.schema.allOf},delete x.schema.allOf,x.schema.$ref="#/definitions/"+h,this.processAllOf(n,h,e.definitions[h],y,O,e)}else this.resolveTo(n,x.schema,y,o);x.$ref&&this.resolveInline(n,e,x,y,O,x.$ref)}for(h in e.paths){var k,$,R;c=e.paths[h];for(k in c)if("$ref"===k)o="/paths"+h,this.resolveInline(n,e,c,y,O,o);else{$=c[k];var I=c.parameters||[],q=$.parameters||[];for(s in I){var x=I[s];q.unshift(x)}"parameters"!==k&&_.isObject($)&&($.parameters=$.parameters||q);for(s in q){var x=q[s];if(o="/paths"+h+"/"+k+"/parameters","body"===x.in&&x.schema)if(_.isArray(x.schema.allOf)){for(var b="inline_model",h=b,A=!1,j=0;!A;){if("undefined"==typeof e.definitions[h]){A=!0;break}h=b+"_"+j,j++}e.definitions[h]={allOf:x.schema.allOf},delete x.schema.allOf,x.schema.$ref="#/definitions/"+h,this.processAllOf(n,h,e.definitions[h],y,O,e)}else this.resolveTo(n,x.schema,y,o);x.$ref&&this.resolveInline(n,e,x,y,O,x.$ref)}for(R in $.responses){var w=$.responses[R];if(o="/paths"+h+"/"+k+"/responses/"+R,_.isObject(w)&&(w.$ref&&this.resolveInline(n,e,w,y,O,o),w.schema)){var T=w;if(_.isArray(T.schema.allOf)){for(var b="inline_model",h=b,A=!1,j=0;!A;){if("undefined"==typeof e.definitions[h]){A=!0;break}h=b+"_"+j,j++}e.definitions[h]={allOf:T.schema.allOf},delete T.schema.allOf,delete T.schema.type,T.schema.$ref="#/definitions/"+h,this.processAllOf(n,h,e.definitions[h],y,O,e)}else"array"===T.schema.type?T.schema.items&&T.schema.items.$ref&&this.resolveInline(n,e,T.schema.items,y,O,o):this.resolveTo(n,w.schema,y,o)}}}c.parameters=[]}var S,U=0,D=[],C=y;for(s=0;s<C.length;s++){var P=C[s];if(n===P.root){if("ref"===P.resolveAs){var H,N=((P.root||"")+"/"+P.key).split("/"),z=[],E="";if(P.key.indexOf("../")>=0){for(var J=0;J<N.length;J++)".."===N[J]?z=z.slice(0,z.length-1):z.push(N[J]);for(H=0;H<z.length;H++)H>0&&(E+="/"),E+=z[H];P.root=E,D.push(P)}else if(S=P.key.split("#"),2===S.length){0!==S[0].indexOf("http:")&&0!==S[0].indexOf("https:")||(P.root=S[0]),o=S[1].split("/");var Q,B=e;for(H=0;H<o.length;H++){var F=o[H];if(""!==F){if(B=B[F],"undefined"==typeof B){Q=null;break}Q=B}}null===Q&&D.push(P)}}else if("inline"===P.resolveAs){if(P.key&&P.key.indexOf("#")===-1&&"/"!==P.key.charAt(0)){for(S=P.root.split("/"),o="",s=0;s<S.length-1;s++)o+=S[s]+"/";o+=P.key,P.root=o,P.location=""}D.push(P)}}else D.push(P)}U=D.length;for(var G={},K=0;K<D.length;K++)!function(e,i,r,t,o){if(e.root&&e.root!==n)if(r.failedUrls.indexOf(e.root)===-1){var s={useJQuery:!1,url:e.root,method:"get",headers:{accept:r.scope.swaggerRequestHeaders||"application/json"},on:{error:function(o){u+=1,console.log("failed url: "+s.url),r.failedUrls.push(s.url),t&&delete t[e.root],O[e.key]={root:e.root,location:e.location},u===U&&r.finish(i,p,y,m,O,l)},response:function(o){var s=o.obj;t&&delete t[e.root],r.resolverCache&&(r.resolverCache[e.root]=s),r.resolveItem(s,e.root,y,m,O,e),u+=1,u===U&&r.finish(i,p,y,m,O,l)}}};f&&f.fetchSpecTimeout&&(s.timeout=f.fetchSpecTimeout),f&&f.clientAuthorizations&&f.clientAuthorizations.apply(s),function e(){setTimeout(function(){if(t[s.url])e();else{var i=r.resolverCache[s.url];_.isObject(i)?(s.on.response({obj:i}),1):(t[s.url]=!0,(new SwaggerHttp).execute(s,a))}},0)}()}else u+=1,O[e.key]={root:e.root,location:e.location},u===U&&r.finish(i,p,y,m,O,l);else r.resolveItem(i,p,y,m,O,e),u+=1,u===U&&r.finish(i,n,y,m,O,l,!0)}(D[K],e,this,G,K);0===Object.keys(D).length&&this.finish(e,p,y,m,O,l)},Resolver.prototype.resolveItem=function(e,i,r,t,o,s){var n=s.location,l=e,f=n.split("/");if(""!==n)for(var a=0;a<f.length;a++){var p=f[a];if(p.indexOf("~1")!==-1&&(p=f[a].replace(/~0/g,"~").replace(/~1/g,"/"),"/"!==p.charAt(0)&&(p="/"+p)),"undefined"==typeof l||null===l)break;if(""===p&&a===f.length-1&&f.length>1){l=null;break}p.length>0&&(l=l[p])}var h=s.key;f=s.key.split("/");var c=f[f.length-1];c.indexOf("#")>=0&&(c=c.split("#")[1]),null!==l&&"undefined"!=typeof l?t[h]={name:c,obj:l,key:s.key,root:s.root}:o[h]={root:s.root,location:s.location}},Resolver.prototype.finish=function(e,i,r,t,o,s,n){var l;for(l in r){var f=r[l],a=f.key,p=t[a];if(p)if(e.definitions=e.definitions||{},"ref"===f.resolveAs){if(n!==!0)for(a in p.obj){var h=this.retainRoot(a,p.obj[a],f.root);p.obj[a]=h}e.definitions[p.name]=p.obj,f.obj.$ref="#/definitions/"+p.name}else if("inline"===f.resolveAs){var c=f.obj;c["x-resolved-from"]=[f.key],delete c.$ref;for(a in p.obj){var h=p.obj[a];n!==!0&&(h=this.retainRoot(a,p.obj[a],f.root)),c[a]=h}}}var d=this.countUnresolvedRefs(e);0===d||this.iteration>5?(this.resolveAllOf(e.definitions),this.resolverCache=null,s.call(this.scope,e,o)):(this.iteration+=1,this.resolve(e,i,s,this.scope))},Resolver.prototype.countUnresolvedRefs=function(e){var i,r=this.getRefs(e),t=[],o=[];for(i in r)0===i.indexOf("#")?t.push(i.substring(1)):o.push(i);for(i=0;i<t.length;i++)for(var s=t[i],n=s.split("/"),l=e,f=0;f<n.length;f++){var a=n[f];if(""!==a&&(l=l[a],"undefined"==typeof l)){o.push(s);break}}return o.length},Resolver.prototype.getRefs=function(e,i){i=i||e;var r={};for(var t in i)if(i.hasOwnProperty(t)){var o=i[t];if("$ref"===t&&"string"==typeof o)r[o]=null;else if(_.isObject(o)){var s=this.getRefs(o);for(var n in s)r[n]=null}}return r},Resolver.prototype.retainRoot=function(e,i,r){if(_.isObject(i))for(var t in i){var o=i[t];if("$ref"===t&&"string"==typeof o){if(!isAbsoluteUrl(o)){if(r)if(0===o.indexOf("/")&&isAbsoluteUrl(r))r=r.split("/").splice(0,3).join("/");else{var s=!0,n=r.slice(-1);if("/"!==n&&0!==o.indexOf("#")&&0!==o.indexOf("http:")&&o.indexOf("https:")){s=!1;var l=r.split("/");l=l.splice(0,l.length-1),r="";for(var f=0;f<l.length;f++)r+=l[f]+"/"}0!==o.indexOf("#")&&s&&(o="#"+o)}o=(r||"")+o,i[t]=o}}else _.isObject(o)&&this.retainRoot(t,o,r)}else _.isString(i)&&"$ref"===e&&i.indexOf("http:")===-1&&i.indexOf("https:")===-1&&(i=r+i);return i},Resolver.prototype.resolveInline=function(e,i,r,t,o,s){var n,l,f,a,p=r.$ref,h=r.$ref,c=!1;if(e=e||"",h){if(0===h.indexOf("../")){for(l=h.split("../"),f=e.split("/"),h="",n=0;n<l.length;n++)""===l[n]?f=f.slice(0,f.length-1):h+=l[n];for(e="",n=0;n<f.length-1;n++)n>0&&(e+="/"),e+=f[n];c=!0}if(h.indexOf("#")>=0)if(0===h.indexOf("/"))a=h.split("#"),l=e.split("//"),f=l[1].split("/"),e=l[0]+"//"+f[0]+a[0],s=a[1];else{if(a=h.split("#"),""!==a[0]){if(f=e.split("/"),f=f.slice(0,f.length-1),!c){e="";for(var d=0;d<f.length;d++)d>0&&(e+="/"),e+=f[d]}e+="/"+h.split("#")[0]}s=a[1]}if(0===h.indexOf("http:")||0===h.indexOf("https:"))h.indexOf("#")>=0?(e=h.split("#")[0],s=h.split("#")[1]):(e=h,s=""),t.push({obj:r,resolveAs:"inline",root:e,key:p,location:s});else if(0===h.indexOf("#"))s=h.split("#")[1],t.push({obj:r,resolveAs:"inline",root:e,key:p,location:s});else if(0===h.indexOf("/")&&h.indexOf("#")===-1){s=h;var v=e.match(/^https?\:\/\/([^\/?#]+)(?:[\/?#]|$)/i);v&&(e=v[0]+h.substring(1),s=""),t.push({obj:r,resolveAs:"inline",root:e,key:p,location:s})}else t.push({obj:r,resolveAs:"inline",root:e,key:p,location:s})}else"array"===r.type&&this.resolveTo(e,r.items,t,s)},Resolver.prototype.resolveTo=function(e,i,r,t){var o,s,n=i.$ref,l=e;if("undefined"!=typeof n&&null!==n){if(n.indexOf("#")>=0){var f=n.split("#");if(f[0]&&0===n.indexOf("/"));else if(!f[0]||0!==f[0].indexOf("http:")&&0!==f[0].indexOf("https:")){if(f[0]&&f[0].length>0){for(o=e.split("/"),l="",s=0;s<o.length-1;s++)l+=o[s]+"/";l+=f[0]}}else l=f[0],n=f[1];t=f[1]}else if(0===n.indexOf("http:")||0===n.indexOf("https:"))l=n,t="";else{for(o=e.split("/"),l="",s=0;s<o.length-1;s++)l+=o[s]+"/";l+=n,t=""}r.push({obj:i,resolveAs:"ref",root:l,key:n,location:t})}else if("array"===i.type){var a=i.items;this.resolveTo(e,a,r,t)}else if(i&&(i.properties||i.additionalProperties)){var p=this.uniqueName("inline_model");i.title&&(p=this.uniqueName(i.title)),delete i.title,this.spec.definitions[p]=_.cloneDeep(i),i.$ref="#/definitions/"+p,delete i.type,delete i.properties}},Resolver.prototype.uniqueName=function(e){for(var i=e,r=0;;){if(!_.isObject(this.spec.definitions[i]))return i;i=e+"_"+r,r++}},Resolver.prototype.resolveAllOf=function(e,i,r){r=r||0,i=i||e;var t;for(var o in i)if(i.hasOwnProperty(o)){var s=i[o];if(null===s)throw new TypeError("Swagger 2.0 does not support null types ("+i+").  See https://github.com/swagger-api/swagger-spec/issues/229.");if("object"==typeof s&&this.resolveAllOf(e,s,r+1),s&&"undefined"!=typeof s.allOf){var n=s.allOf;if(_.isArray(n)){var l=_.cloneDeep(s);delete l.allOf,l["x-composed"]=!0,"undefined"!=typeof s["x-resolved-from"]&&(l["x-resolved-from"]=s["x-resolved-from"]);for(var f=0;f<n.length;f++){var a=n[f],p="self";"undefined"!=typeof a["x-resolved-from"]&&(p=a["x-resolved-from"][0]);for(var h in a)if(l.hasOwnProperty(h))if("properties"===h){var c=a[h];for(t in c){l.properties[t]=_.cloneDeep(c[t]);var d=c[t]["x-resolved-from"];"undefined"!=typeof d&&"self"!==d||(d=p),l.properties[t]["x-resolved-from"]=d}}else if("required"===h){for(var v=l.required.concat(a[h]),u=0;u<v.length;++u)for(var m=u+1;m<v.length;++m)v[u]===v[m]&&v.splice(m--,1);l.required=v}else"x-resolved-from"===h&&l["x-resolved-from"].push(p);else if(l[h]=_.cloneDeep(a[h]),"properties"===h)for(t in l[h])l[h][t]["x-resolved-from"]=p}i[o]=l}}}};
